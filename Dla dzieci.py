...
owoce = book.add_sheet("żywność dla dzieci")
warzywa = book.add_sheet("pieluchy i chusteczki")
salatki = book.add_sheet("pielegnacja")
ziola = book.add_sheet("akcesoria dla dzieci")
grzyby = book.add_sheet("akcesoria dla mam")

arkusz = [owoce,warzywa,salatki,ziola, grzyby]
lista = []
cena_laczna = []
ilosc =[]
waga = []
...
adres = [
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/dla-dzieci/zywnosc-dla-dzieci/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/dla-dzieci/pieluchy-i-chusteczki/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/dla-dzieci/pielegnacja/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/dla-dzieci/akcesoria-dla-dzieci/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/dla-dzieci/akcesoria-dla-mam/all?page='
         ]
