...
owoce = book.add_sheet("mieso i drob na wage")
warzywa = book.add_sheet("mieso i drob paczkowane")
salatki = book.add_sheet("wędliny")
ziola = book.add_sheet("Ryby")
grzyby = book.add_sheet("garmaż")
orzechy_ziarniste = book.add_sheet("dania gotowe")


arkusz = [owoce,warzywa,salatki,ziola, grzyby,orzechy_ziarniste]
lista = []
cena_laczna = []
ilosc =[]
waga = []
...
adres = ['https://ezakupy.tesco.pl/groceries/pl-PL/shop/mieso-ryby-garmaz/mieso-i-drob-na-wage/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/mieso-ryby-garmaz/mieso-i-drob-paczkowane/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/mieso-ryby-garmaz/wedliny/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/mieso-ryby-garmaz/ryby/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/mieso-ryby-garmaz/garmaz/all?page=',
         'https://ezakupy.tesco.pl/groceries/pl-PL/shop/mieso-ryby-garmaz/dania-gotowe/all?page=']
...
book.save("Mieso_Ryby_Garmaz.xls")
